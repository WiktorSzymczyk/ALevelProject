...
public class SkinProvider extends ContentProvider {
    public static final String LOG_TAG = SkinProvider.class.getSimpleName();
    ...
    static {
        ...
        sUriMatcher.addURI(SkinContract.CONTENT_AUTHORITY, SkinContract.PATH_SKIN, FRAGRANCES);

        sUriMatcher.addURI(SkinContract.CONTENT_AUTHORITY, SkinContract.PATH_CART, CART);
        ...
        sUriMatcher.addURI(SkinContract.CONTENT_AUTHORITY, SkinContract.PATH_SKIN + "/#", FRAGRANCE_ID);
        sUriMatcher.addURI(SkinContract.CONTENT_AUTHORITY, SkinContract.PATH_CART + "/#", CART_ID);

    }

    /** Database helper object */
    private SkinDbHelper skinDbHelper;

    @Override
    public boolean onCreate() {
        skinDbHelper = new SkinDbHelper(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        SQLiteDatabase database = skinDbHelper.getReadableDatabase();
        ...
        switch (match) {
            case FRAGRANCES:
                ...
                cursor = database.query(SkinContract.SkinEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case CART:
                cursor = database.query(SkinContract.SkinEntry.CART_TABLE, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case CART_ID:
                selection = SkinContract.SkinEntry.CARTID + "=?";
            ...
            case FRAGRANCE_ID:
                ...
                selection = SkinContract.SkinEntry.ID + "=?";
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };
    ...
    private Uri insertCart(Uri uri, ContentValues values) {
        ...
        SQLiteDatabase database = skinDbHelper.getWritableDatabase();

        // Insert the new cart with the given values
        long id = database.insert(SkinContract.SkinEntry.CART_TABLE, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        final SQLiteDatabase db = skinDbHelper.getWritableDatabase();
        ...
        switch (match) {
            ...
            case CART_ID:
                ...
                cartDeleted = db.delete(SkinContract.SkinEntry.CART_TABLE, "_id=?", new String[]{id});
                break;
            default:
